...
lst.anexarInicioList(datoInicio);
--datoInicio;
listar();
}
/**
...
lista.leerMenu();
    ...
    private static class Lista {
        ...
        private void anexarFinalLista(int dato) {
            throw new UnsupportedOperationException("Not supported yet."); 
        }

        private void anexarInicioList(int datoInicio) {
            throw new UnsupportedOperationException("Not supported yet.");
        }
        ...
        private boolean buscarNodo(int n) {
            throw new UnsupportedOperationException("Not supported yet.");
        }

        private boolean borrarNodoFinal() {
            throw new UnsupportedOperationException("Not supported yet."); 
        }
    }
}
